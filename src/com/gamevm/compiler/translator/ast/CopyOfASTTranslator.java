...
public class CopyOfASTTranslator extends Translator<ASTNode, Statement> {
	...
	public CopyOfASTTranslator(SymbolTable symbolTable, boolean generateDebugInformation) {
		...
		try {
			...
			case ASTNode.TYPE_VAR_DECL:
				...
				if (n.getChildCount() > 2) {
					...
					return addDebugInformation(n, new VariableDeclaration<Object>(i, t, s, e));
				} else {
					return addDebugInformation(n, new VariableDeclaration<Object>(i, t, s, null));
				}
			case ASTNode.TYPE_ASSIGNMENT:
