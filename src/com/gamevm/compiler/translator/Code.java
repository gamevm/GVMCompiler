...
public class Code<I extends Instruction> {
	...
	public Code(DataInputStream input, CodeReader<I> reader, int codeSize) throws IOException {
...
//			}
	...
	public void write(DataOutputStream output, CodeWriter<I> writer) throws IOException {
